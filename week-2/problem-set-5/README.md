...
- [test_plates.py](test_plates/test_plates.py) — testing validation functions, edge cases — ✅
- [test_fuel.py](test_fuel/test_fuel.py) — testing fractions, exceptions, edge cases — ✅
...
- Testing exceptions with `pytest.raises(ValueError)`
- One assertion per concept, not per file
- Writing tests forces you to think about edge cases upfront